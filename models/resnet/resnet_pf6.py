...
__all__ = ['pf6_resnet18', 'pf6_resnet34', 'pf6_resnet50', 'pf6_resnet101', 'pf6_resnet152']
...
def pf6_resnet18(pretrained=False, **kwargs):
...
def pf6_resnet34(pretrained=False, **kwargs):
...
def pf6_resnet50(pretrained=False, **kwargs):
...
def pf6_resnet101(pretrained=False, **kwargs):
...
def pf6_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = pf6_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = pf6_resnet50(num_classes=1000).cuda()
