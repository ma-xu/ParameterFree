...
def pf5_resnet18(pretrained=False, **kwargs):
...
def pf5_resnet34(pretrained=False, **kwargs):
...
def pf5_resnet50(pretrained=False, **kwargs):
...
def pf5_resnet101(pretrained=False, **kwargs):
...
def pf5_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = pf5_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = pf5_resnet50(num_classes=1000).cuda()
